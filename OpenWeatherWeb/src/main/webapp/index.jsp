...
<%@page import="parser.OpenWeather"%>
...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <body>
        <header>
            <!-- place navbar here -->
            <h1 class="text-center p-3">Tiempo en toledo</h1>
        </header>
        <main>
            <div class="container">
                <div class="row">
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-8 bg-dark text-white">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Temperatura mínima: <span class="text-primary"><%= dia.getTempMin() %></span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <footer>
            <!-- place footer here -->
             <h1 class="bg-dark text-white text-center m-0 p-0 lh-base">&copy; Manuel Novillo Romocea</h1>
        </footer>
