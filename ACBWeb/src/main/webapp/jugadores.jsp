		...
		<main>
			<div class="shadow">
				<div class="bg-secondary text-center py-3">
					<img src="${equipo.imgescudo}" alt="" width="150"
						class="bg-white p-3 rounded-circle">
						...
						<div class="col-6 col-md-4 mb-3">
							<div class="card position-relative">
								<div class="row">
									...
									<div class="col-5">
										<img src="${jugador.imagen}" alt="" class="img-fluid">
									</div>
									<div class="col-5">
										<h5 class="card-title mt-3">${jugador.nombre}</h5>
										<p class="card-text m-0">${jugador.estatura} m</p>
								...
								<div class="position-absolute bottom-0 end-0">
									<span class="h2">${jugador.likes}</span>
										<a href="Controller?op=dalike&jugadorid=${jugador.id}"> 
